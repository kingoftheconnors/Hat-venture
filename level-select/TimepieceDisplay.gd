...
func _ready():
	print(SaveSystem.get_tag("satellite_aligned"))
	print(SaveSystem.get_tag("timepieces_stolen"))
	if SaveSystem.get_tag("satellite_aligned") == null \
		or SaveSystem.get_tag("timepieces_stolen") == null:
...
func pressed():
	...
	elif SaveSystem.get_tag("timepieces_stolen") == null:
		$Exclamation.visible = false
		$TimePieces.visible = true
		# TODO: Play sfx
